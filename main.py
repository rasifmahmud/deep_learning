...
from data.data_preprocessors import cat_vs_non_cat_data_pre_processor
...
dnn = DeepNeuralNetwork(data_processor_callback=cat_vs_non_cat_data_pre_processor, layer_dims=[4, 3, 2, 1])
